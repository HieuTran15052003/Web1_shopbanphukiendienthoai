...
$noidung = isset($_POST['noidung']) ? trim($_POST['noidung']) : null;
...
if (isset($_POST['themsanpham'])) {
    ...
    try {
        $sql_them = "INSERT INTO product(tensanpham, masp, giasp, soluong, hinhanh, tomtat, noidung, tinhtrang, id) 
        VALUES (:tensanpham, :masp, :giasp, :soluong, :hinhanh, :tomtat, :noidung, :tinhtrang, :id)";
